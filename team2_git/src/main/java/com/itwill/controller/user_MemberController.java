...
//	}
	...
	public String user_registerPro(user_MemberDTO user_memberDTO) {
		System.out.println("user_MemberController user_resigsterPro");
...
//		memberDTO.setId(request.getParameter("id"));
		...
		System.out.println(user_memberDTO.getU_name());
		System.out.println(user_memberDTO.getU_nic());
		System.out.println(user_memberDTO.getU_email());
		System.out.println(user_memberDTO.getU_phone());
...
//		memberService.insertMember(memberDTO);
		...
		//멤버변수 정의 <= 외부에 있는 xml에서 MemberServiceImpl 객체생성한 것을 전달해오면 받음
		//받아오는 방법 1. 생성자  2. set 메서드
		user_memberService.user_insertMember(user_memberDTO);
