      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span>이벤트와 공지사항입니다.</span></p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                <ul>
                <li><a href="${pageContext.request.contextPath}/notice/update?b_num=${noticeDTO.b_num}" class="btn py-3 px-4 btn-primary">글수정 </a></li>
                <li><a onclick="return confirm('정말로 삭제하시겠습니까?')" href="${pageContext.request.contextPath}/notice/delete?b_num=${noticeDTO.b_num}" class="btn py-3 px-4 btn-primary">글삭제 </a></li>
