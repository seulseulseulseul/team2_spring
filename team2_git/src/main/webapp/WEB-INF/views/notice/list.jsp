			          ...
			          <div class="block-27">
			            <ul>
							 ...
							 <c:if test="${pageDTO.startPage > pageDTO.pageBlock}">
					             <li><a href="${pageContext.request.contextPath}/notice/list?pageNum=${pageDTO.startPage-pageDTO.pageBlock}">&lt;</a></li>
								</c:if>
					            <!-- var: 변수명. begin: 시작. end: 끝. step:증가  -->
								<c:forEach var="i" begin="${pageDTO.startPage}" end="${pageDTO.endPage}" step="1">
								<li class="active"><a href="${pageContext.request.contextPath}/notice/list?pageNum=${i }">${i }</a></li>
								</c:forEach>
