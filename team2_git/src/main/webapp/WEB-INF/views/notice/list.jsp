...
<!-- 		              </a> -->
				...
				List<NoticeDTO> noticeList = noticeDAO.getNoticeList(startRow, pageSize);
				SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy.MM.dd");
				for(int i=0;i<noticeList.size();i++){
					//boardList 한칸접근 게시판 한개 들고 오기
					// BoardDTO boardDTO = (BoardDTO)boardList.get(i);
					NoticeDTO noticeDTO = (NoticeDTO)noticeList.get(i);
	          	%>
	          	...
	          	<div class="col-md-12 d-flex ftco-animate">
		              ...
		              <div class="text pl-md-4 ml-md-2 pt-4">
		              	<div class="meta">
		                  <div><a href="#"><%=dateFormat.format(noticeDTO.getDate())%></a></div>
		                  <div><a href="#"><%=noticeDTO.getU_num() %></a></div>
		               
		                	<div><a href="#" class="meta-chat"><span class="icon-chat"></span>이벤트</a></div>
		               
		                </div>
		                <h3 class="heading mt-2"><a href="content.jsp?b_num=<%=noticeDTO.getB_num()%>"><%=noticeDTO.getB_title() %></a></h3>
		                
		                <p><a href="content.jsp?b_num=<%=noticeDTO.getB_num()%>" class="btn btn-outline-primary">글 보기</a></p>
		              </div>
		            </div>
		          </div>
