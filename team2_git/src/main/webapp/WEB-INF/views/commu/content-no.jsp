    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row">
          ...
          <div>1999.99.99</div>
		  <div>작성자</div>
            <h2 class="mb-3">제목입니다.</h2>
            <p>글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 글내용 
            </p>
              ...
              <div class="comment-form-wrap pt-5">
                <h3 class="mb-5">댓글</h3>
                <form action="commentPro.jsp" class="bg-light p-4" method="post">
                  <div class="form-group">
                    <label for="content">닉네임</label>
