...
<!--                   </div> -->
            ...
            <!-- 트레이너 상세정보 이미지 -->
             ...
             <img src="trainerimage\<%= memberDTO.getPhoto_name()%>">
...
<!--                   </div> -->
    ...
    <section class="ftco-section">
       <div class="container">
          <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-12 heading-section ftco-animate text-center">
    <h2 class="mb-1">트레이너 <%= memberDTO.getT_nic()%> 소개 동영상<br></h2>
      <p align = "middle">
		<iframe width="80%" height="500" src="<%=memberDTO.getVideo()%>?autoplay=1&amp;mute=1" title="YouTube video player"
