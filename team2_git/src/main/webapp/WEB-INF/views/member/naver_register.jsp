			...
			<div class="container">
                ...
                <form action="${pageContext.request.contextPath}/member/user_registerPro" id="join" method="post">
								<div class="form-group">
									<label>ID</label>
									<input type="text" name="u_id" id="u_id" class="form-control"  value='<c:out value="${userInfo.u_id}"/>' readonly>
								</div>					
								<div class="form-group">
									<label class="fw">비밀번호</label>
									<input type="password" name="u_pass" id="u_pass" class="form-control" value='0000'>
								</div>
								<div class="form-group">
									<label>이름</label>
