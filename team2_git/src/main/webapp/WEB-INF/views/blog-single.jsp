      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <p>
              <img src="${pageContext.request.contextPath}/resources/images/image_1.jpg" alt=" class="img-fluid">
            </p>
            ...
            <p>
              <img src="${pageContext.request.contextPath}/resources/images/image_2.jpg" alt=" class="img-fluid">
            </p>
            ...
            <div class="about-author d-flex">
              <div class="bio align-self-md-center mr-5">
                <img src="${pageContext.request.contextPath}/resources/images/person_2.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="${pageContext.request.contextPath}/resources/images/person_2.jpg" alt="Image placeholder">
                  </div>
